...
public class APKdownAsyncTask extends AsyncTask<String,Void,Boolean> {
    ...
    protected Boolean doInBackground(String... arg0) {
        ...
        try {
            ...
            intent.setDataAndType(Uri.fromFile(new File(Environment.getExternalStorageDirectory().toString()+"DexTest.apk")), "application/vnd.android.package-archive");
